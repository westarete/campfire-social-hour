defmodule CampfireSocialHourWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CampfireSocialHourWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {CampfireSocialHourWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import CampfireSocialHourWeb.LiveHelpers
